            ...
            <div class="tarjeta tarjeta-formulario ancho-grande">
                ...
                <form method="post" action="/html/usuarios_html.php">
                    ...
                    <div class="acciones-formulario">
                        ...
                        <?php if ($editar): ?>
                            <a class="boton boton-enlace" href="/html/usuarios_html.php">Cancelar</a>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
                        ...
                        <?php if ($listado && $listado->num_rows > 0): ?>
                            <?php while ($fila = $listado->fetch_assoc()): ?>
                                <tr class="table-row-hover">
                                    ...
                                    <td>
                                        <a class="boton boton-pequeno boton-primario" href="/html/usuarios_html.php?editar=<?php echo urlencode($fila['dni']); ?>">Editar</a>
                                        <a class="boton boton-pequeno boton-rechazar" href="/html/usuarios_html.php?eliminar=<?php echo urlencode($fila['dni']); ?>" onclick="return confirm('¿Eliminar usuario?');">Eliminar</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
